...
class AboutDialog(QDialog, FORM_CLASS):
    ...
    def getAboutText(self):
        return self.tr('<p>Easy to use queries.</p>'
            '<p>Plugin is an alternative for Select features using expression tool. The idea is to provide less comprehensive, but more intuitive way to run simple queries.</p>'
